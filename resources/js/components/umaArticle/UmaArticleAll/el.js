...
const el = () => {
  return (
    <div>
      <div id="TopImgcss">
        <img src="/img/intro/IntroEl.png" id="TopImgSize" />
        <img src="/img/intro/SubEl.png" id="imgAbsolute" />
        <img src="/img/Form/FormEl.png" id="imgAbsolute2"/>
      </div>
      ...
      <br/>
        <table>
          ...
          <tbody>
            <tr>
              <td>芝<br/>--------------<br/>ダート</td><td>マイル<br/>--------------<br/>中距離<br/>--------------<br/>長距離</td><td>先行<br/>--------------<br/>差し</td>
            </tr>
          </tbody>
        </table>
        <br/>
        ...
        <table>
          <thead>
            ...
            <tr><th>脚質適性</th><td><img src="/img/Icon/showE.png" id="imgsize" /><br/>----------<br/>逃げ</td><td><img src="/img/Icon/showA.png" id="imgsize" /><br/>----------<br/>先行</td><td><img src="/img/Icon/showA.png" id="imgsize" /><br/>----------<br/>差し</td><td><img src="/img/Icon/showC.png" id="imgsize" /><br/>----------<br/>追込</td></tr>
          </thead>
        </table>
        <br/>
        <br/>

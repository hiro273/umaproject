...
const nice = () => {
  return (
    <div id="tableLine">
      ...
      <div id="leftcss">
        <img src="/img/Form/FormNice.png"/>
      </div>

      
      <div id="rightcss">
      <img src="/img/intro/IntroNice.png" id="introSize"/>
      <br/>
      <br/>
        <table>
          <thead>
        ...
        <table>
          <thead>
            ...
            <tr><th>脚質適性</th><td><img src="/img/Icon/showF.png" id="imgsize" /><br/>----------<br/>逃げ</td><td><img src="/img/Icon/showB.png" id="imgsize" /><br/>----------<br/>先行</td><td><img src="/img/Icon/showA.png" id="imgsize" /><br/>----------<br/>差し</td><td><img src="/img/Icon/showD.png" id="imgsize" /><br/>----------<br/>追込</td></tr>
          </thead>
        </table>
        <br/>
        <br/>
